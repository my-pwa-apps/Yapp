              ...
              {prefs.enabled && (
                <>
                  <div className="notif-setting-row">
                    ...
                    <button
                      type="button"
                      className={toggleClass(prefs.messages)}
                      onClick={() => handleToggle('messages')}
                      aria-pressed={prefs.messages}
                      aria-label="Messages"
                    >
                      <span className="notif-toggle-thumb" />
                    </button>
                  ...
                  <div className="notif-setting-row">
                    ...
                    <button
                      type="button"
                      className={toggleClass(prefs.groupInvites)}
                      onClick={() => handleToggle('groupInvites')}
                      aria-pressed={prefs.groupInvites}
                  ...
                  <div className="notif-setting-row">
                    ...
                    <button
                      type="button"
                      className={toggleClass(prefs.joinRequests)}
                      onClick={() => handleToggle('joinRequests')}
                      aria-pressed={prefs.joinRequests}
                  ...
                  <div className="notif-setting-row">
                    ...
                    <button
                      type="button"
                      className={toggleClass(prefs.contactRequests)}
                      onClick={() => handleToggle('contactRequests')}
                      aria-pressed={prefs.contactRequests}
