        ...
        {activeChat ? (
          ...
          <div className="no-chat">
            ...
            <div className="no-chat-actions">
              <button className="modal-btn modal-btn-primary" onClick={() => setShowNewChat(true)}>
                <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z" transform="rotate(180, 12, 12)"/></svg>
                New Chat
              </button>
              <button className="modal-btn modal-btn-secondary" onClick={() => setShowNewGroup(true)}>
